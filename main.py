"""
╔══════════════════════════════════════════════════════════════╗
║     SMC PRO v4 — BACKTEST v6.0                              ║
║                                                              ║
║  Changes from v5 (based on backtest data):                 ║
...
║  Output: backtest_smc_v6_results.xlsx                       ║
╚══════════════════════════════════════════════════════════════╝
"""
...
# SMC constants
MIN_SCORE            = 85      # RAISED: 80-85 band = 38% WR in v5 (5th version same pattern)
...
# v4 NEW filter
REQUIRE_FVG          = True    # FVG=YES → 75% WR vs 60% without in v3
...
OUTPUT_FILE = '/mnt/user-data/outputs/backtest_smc_v6_results.xlsx'
...
def analyse_candle(df_4h, df_1h, df_15m, signal_bar_idx):
    ...
    # ── v4 GATE: REQUIRE FVG overlapping OB ──
    # FVG=YES → 75% WR in v3 vs 60% without. Require it.
...
""")
    ...
    print(f"""
╔══════════════════════════════════════════════════════╗
║      📊 SMC PRO v4 BACKTEST v6 — RESULTS            ║
╚══════════════════════════════════════════════════════╝
